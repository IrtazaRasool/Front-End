...
function page2Animation() {
  let clutter = "";
  var h1 = document.querySelector("#page2 h1").innerHTML.split(" ");
  h1.forEach(function (dets) {
  ...
  gsap.to("#page2 h1 span", {
    ...
    scrollTrigger: {
      trigger: "#page2 h1",
      start: "top bottom",
      // top first value is for elem and second value is for screen
      end: "bottom 75%",
      scroller: "#main",
      scrub: 0.5,
    },
...
function page4Animation() {
  let clutter = "";
  var split = document.querySelector("#page4 h1").innerHTML.split(" ");
...
function page6Animation() {
  let clutter = "";
  var split = document.querySelector("#page6 h1").innerHTML.split(" ");
  split.forEach(function (word) {
    clutter += `<span> ${word} </span>`;
  });
